...
export default function Home() {
  ...
  return (
    <Layout
      ...
      description="Cliente API open-source para integrar fácilmente pagos con Flow.cl en aplicaciones Node.js y JavaScript."
    >
      <header className={clsx('hero hero--primary', styles.heroBanner)}>
        ...
        >
          <img
            ...
            alt="Cliente API para integración de pagos"
            className={styles.heroImage}
          />
          <h1 className="hero__title">{siteConfig.title}</h1>
          <p className="hero__subtitle">
            Un Cliente API open-source que facilita la integración de pagos con Flow.cl
      ...
      <main className={`container margin-vert--xl ${styles.main}`}>
        <section className="row">
          <div className="col col--6">
            <h2>¿Qué ofrece este Cliente API?</h2>
            <p>
          ...
          <div className={
            ...
            <img
              ...
              alt="Ejemplo de uso del Cliente API"
            />
          </div>
        </section>
            ...
            <div className="row">
              ...
              <div className="col col--4">
                ...
                <p>
                  ...
                  utilizar el Cliente API sin complicaciones.
                </p>
              </div>
            </div>
          </div>
